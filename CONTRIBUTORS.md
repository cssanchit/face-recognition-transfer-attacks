...
| `MI_ADMIX_DI_TI` | *Admix* (ICCV 2021) with DI/TI-style transfer components | Xiaosen Wang, Jiefeng Chen, Si'wei Lyu, Yisen Wang | Shared repository implementation integrated by **Vishaka** from **Delhi University** |
