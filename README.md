...
| [`ADAMSI_FGM`](attacks/adamsi_fgm) | *On the Convergence of an Adaptive Momentum Method for Adversarial Attacks* (AAAI 2024) | Yuxiao Long, Xuanyu Yi, Jinglun Xu, Yuan Wu, Xiaosen Wang | CNN face-verification adaptation contributed by **Bhumika Singh** from **SRM Institute of Science and Technology** |
...
| [`PGN`](attacks/pgn) | *Boosting Adversarial Transferability by Achieving Flat Local Maxima* (NeurIPS 2023) | Yao Ge, Yao Xiao, Weijie Huang, Xiaosen Wang, Yong Liu, Bo Han, Jiang Bian, Chunhua Shen | CNN face-verification adaptation contributed by [**Chidroopa Kanaparthy**](https://github.com/Chidroopakanaparthy) from **Maharaja Agrasen Institute of Technology (MAIT)** |
